...
-- Insertar en TbInv_Sucursal
INSERT INTO TbInv_Sucursal (Id_Sucursal, Id_Empresa_Suc, Nombre_Parametro_Suc, Nombre_Suc, Estado_Suc) VALUES
(1, 1, 'Parametro1', 'Sucursal A', 'AC'),
(2, 1, 'Parametro2', 'Sucursal B', 'AC'),
(3, 1, 'Parametro3', 'Sucursal C', 'AC'),
(4, 1, 'Parametro4', 'Sucursal D', 'AC'),
(5, 1, 'Parametro5', 'Sucursal E', 'AC'),
(6, 1, 'Parametro6', 'Sucursal F', 'AC'),
(7, 1, 'Parametro7', 'Sucursal G', 'AC');

-- Insertar en TbInv_Industria
...
-- Insertar en Tb_Inv_Almacen
INSERT INTO TbInv_Almacen (Id_Sucursal_Alm, Nombre_Alm, Ubicacion_Alm, Capacidad_maxima_Alm, Estado_Alm) VALUES
(1, 'Almacen 1', 'Ubicacion 1', 500, 'AC'),
(2, 'Almacen 2', 'Ubicacion 2', 300, 'AC'),
(3, 'Almacen 3', 'Ubicacion 3', 400, 'AC'),
(4, 'Almacen 4', 'Ubicacion 4', 350, 'AC'),
(5, 'Almacen 5', 'Ubicacion 5', 600, 'AC'),
(6, 'Almacen 6', 'Ubicacion 6', 200, 'AC'),
(7, 'Almacen 7', 'Ubicacion 7', 450, 'AC');

-- Insertar en TbInv_Categoria
INSERT INTO TbInv_Categoria (Nombre_Cat, Id_Categoria_Padre_Cat, Estado_Cat) VALUES
('Categoria A', 1, 'AC');



-- Insertar en TbInv_Marca
INSERT INTO TbInv_Marca (Nombre_Mar, Estado_Mar) VALUES
('Marca A', 'AC');

-- Insertar en TbInv_Proveedor
INSERT INTO TbInv_Proveedor (Nombre_Prov, Direccion_Prov, Telefono_Prov, Correo_Prov, Estado_Prov) VALUES
('Proveedor A', 'Direccion A', '1234567890', 'proveedorA@mail.com', 'AC');
