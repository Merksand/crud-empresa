...
export default function Sidebar() {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      title: 'Reportes',
      path: '/dashboard/clientes/reportes',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path
            strokeLinecap="round"
          ...
          <div className="p-4 border-t border-gray-200 dark:border-gray-700">
            {isOpen ? (
              ...
              <div className="flex justify-center">
                <div className="w-10 h-10 rounded-full bg-gray-300 flex items-center justify-center text-gray-600 cursor-pointer" onClick={() => setIsOpen(true)}>
                  <span className="text-lg font-semibold">CR</span>
                </div>
              </div>
            )}
